            ...
            <div class="container">
                <div class="col-lg-12">
                    <div class="offers">
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                @foreach($laravel->post()->orderBy('created_at', 'desc')->take(3)->get() as $lara)
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb">
                                            <img src="{{ $lara->featured }}" alt="our case">
                                        </div>
                                        <h6 class="case-item__title"><a href="{{ route('post.single', ['slug' => $lara->slug]) }}">{{ $lara->title }}</a></h6>
                                    </div>
                                </div>
                                @endforeach
                            </div>
                    ...
                    <div class="offers">
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                @foreach($javascript->post()->orderBy('created_at', 'desc')->take(3)->get() as $java)
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item">
                                            <div class="case-item__thumb">
                                                <img src="{{ $java->featured }}" alt="our case">
                                            </div>
                                            <h6 class="case-item__title"><a href="{{ route('post.single', ['slug' => $java->slug]) }}">{{ $java->title }}</a></h6>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                    ...
                    <div class="offers">
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                @foreach($programming->post()->orderBy('created_at', 'desc')->take(3)->get() as $program)
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item">
                                            <div class="case-item__thumb">
                                                <img src="{{ $program->featured }}" alt="our case">
                                            </div>
                                            <h6 class="case-item__title"><a href="{{ route('post.single', ['slug' => $program->slug]) }}">{{ $program->title }}</a></h6>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
